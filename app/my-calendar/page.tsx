...
function getTimeLabel(post: any) {
  ...
  const firstDateKey = selectedDateKey(getSelectedDates(post)[0]);
    ...
    <main className="min-h-screen bg-white p-6">
      ...
      <section className="rounded-[2rem] bg-emerald-800 p-6 text-white shadow-xl">
        ...
        <p className="mt-3 max-w-md text-sm text-white/80">
          Events and deals you’ve saved, organised by day.
        </p>
      </section>

      <div className="mx-auto max-w-2xl">
        {!loading && posts.length === 0 ? (
          <section className="mt-8 rounded-[2rem] bg-neutral-50 p-6 text-center">
            ...
            <p className="mt-2 text-sm text-neutral-500">
              Find events and deals to add to your calendar.
            </p>

            <Link
              href="/calendar"
              className="mt-6 inline-flex items-center justify-center rounded-2xl bg-emerald-800 px-5 py-3 text-sm font-bold text-white"
            >
              Find things to do
            </Link>
          </section>
              ...
              <div className="mb-3 flex items-center justify-between">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm font-semibold text-neutral-500">
                    {monthlyPostCount} saved this month
                  </p>
                </div>
            ...
            <section className="mt-10">
              ...
              {loading ? (
                ...
                <div className="rounded-3xl bg-neutral-100 p-6 text-center">
                  ...
                  <Link
                    href="/calendar"
                    className="mt-3 inline-flex text-sm font-bold text-emerald-800"
                  >
                    Find things to do
                  </Link>
                </div>
