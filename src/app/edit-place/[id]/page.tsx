  ...
  useEffect(() => {
    ...
    async function loadPlace() {
      ...
      try {
        ...
        if (authError) {
          throw new Error(
            `Authentication failed: ${readableError(
              authError
            )}`
          );
        }
        ...
        if (placeError) {
          throw new Error(
            `Place lookup failed: ${readableError(
              placeError
            )}`
          );
        }
        ...
        if (!place.page_id) {
          throw new Error(
            "This Place is not attached to a Page."
          );
        }
        ...
        if (pageError) {
          throw new Error(
            `Page permission check failed: ${readableError(
              pageError
            )}`
          );
        }
        ...
        if (!pageData) {
          throw new Error(
            "You do not have permission to edit this Place, or Places are not enabled for its Page."
          );
        }
